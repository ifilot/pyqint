...
class TestKineticDeriv(unittest.TestCase):
    ...
    def testDerivH2(self):
        ...
        # calculate derivative towards H1 in the x-direction
        fx1 = integrator.kinetic_deriv(cgfs[0], cgfs[0], nuclei[0][0], 0)
        fx2 = integrator.kinetic_deriv(cgfs[1], cgfs[1], nuclei[0][0], 0)
        ...
        # assert that the cross-terms will change
        fx3 = integrator.kinetic_deriv(cgfs[0], cgfs[1], nuclei[0][0], 0)
        fx4 = integrator.kinetic_deriv(cgfs[0], cgfs[1], nuclei[1][0], 0)
        fx5 = integrator.kinetic_deriv(cgfs[1], cgfs[0], nuclei[0][0], 0)
        fx6 = integrator.kinetic_deriv(cgfs[1], cgfs[0], nuclei[1][0], 0)

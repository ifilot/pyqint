...
class TestOverlap(unittest.TestCase):
    ...
    def test_gto_overlap(self):
        ...
        np.testing.assert_almost_equal(overlap, result, 9)
    ...
    def test_cgf_overlap(self):
        ...
        np.testing.assert_almost_equal(S[0,0], S11, 9)
        np.testing.assert_almost_equal(S[1,1], S11, 9)
        np.testing.assert_almost_equal(S[0,1], S12, 9)

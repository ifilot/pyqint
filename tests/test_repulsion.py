...
class TestRepulsion(unittest.TestCase):
    ...
    def test_gto_repulsion(self):
        ...
        np.testing.assert_almost_equal(repulsion, result, 9)
    ...
    def test_cgf_repulsion(self):
        ...
        np.testing.assert_almost_equal(T1111, 0.7746056022391389, 9)
        np.testing.assert_almost_equal(T1122, 0.5696753983165589, 9)
        np.testing.assert_almost_equal(T1112, 0.444107896803155, 9)
        np.testing.assert_almost_equal(T2121, 0.29702881305777407, 9)

        # test similarity between two-electron integrals
        np.testing.assert_almost_equal(T1222, T1112, 9)
        np.testing.assert_almost_equal(T1122, T2211, 9)
    ...
    def test_cgf_repulsion_p(self):
        ...
        np.testing.assert_almost_equal(px_px_py_py, 0.785270228645895, 9)
        np.testing.assert_almost_equal(px_px_px_py, 0.00000000000000000, 9)
        np.testing.assert_almost_equal(px_py_px_py, 0.047444455984311705, 9)
        np.testing.assert_almost_equal(px_py_pz_s,  0.00000000000000000, 9)
    ...
    def test_cgf_repulsion_d(self):
        ...
        np.testing.assert_almost_equal(T1, 1.139718392998638, 9)
        np.testing.assert_almost_equal(T2, 0.9716113017282908, 9)
        np.testing.assert_almost_equal(T3, 1.2524694056556624, 9)
        np.testing.assert_almost_equal(T4, 1.2197180696919803, 9)
    ...
    def test_two_electron_indices(self):
        ...
        np.testing.assert_almost_equal(integrator.teindex(1,1,2,1), integrator.teindex(1,1,1,2), 9)
        np.testing.assert_almost_equal(integrator.teindex(1,1,2,1), integrator.teindex(2,1,1,1), 9)
        np.testing.assert_almost_equal(integrator.teindex(1,2,1,1), integrator.teindex(2,1,1,1), 9)
        np.testing.assert_almost_equal(integrator.teindex(1,1,1,2), integrator.teindex(1,1,2,1), 9)

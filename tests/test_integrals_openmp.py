...
class TestIntegralsOpenMP(unittest.TestCase):
    ...
    def test_integrals_h2o_openmp_sto3g(self):
        ...
        tetensor_result = np.load(os.path.join(os.path.dirname(__file__), 'results', 'h2o_teint_sto3g.npy'))
    ...
    def test_integrals_h2o_openmp_sto6g(self):
        ...
        tetensor_result = np.load(os.path.join(os.path.dirname(__file__), 'results', 'h2o_teint_sto6g.npy'))
    ...
    def test_integrals_h2o_openmp_p321(self):
        ...
        tetensor_result = np.load(os.path.join(os.path.dirname(__file__), 'results', 'h2o_teint_p321.npy'))
    ...
    def test_integrals_h2o_openmp_p631(self):
        ...
        tetensor_result = np.load(os.path.join(os.path.dirname(__file__), 'results', 'h2o_teint_p631.npy'))
